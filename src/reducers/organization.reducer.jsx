...
const reducer = (state = initialState, action) => {
    switch (action.type) {
      ...
      case organization.EDIT_ORGANIZATION_FAILURE:
        return { ...state, editOrganizationError: action.payload.error, fetchOrganizationLoading: false};
      ...
      case organization.FETCH_ORGANIZATIONS_FAILURE:
        ...
        case organization.FETCH_ORGANIZATION_FAILURE:
            return { ...state, fetchOrganizationError: action.payload.error, fetchOrganizationLoading: false};
