      ...
      <div>
        ...
        <GridContainer justify="center">
          <GridItem xs={12} sm={12} md={10}>
            ...
            <Select name="userStatus" value={this.state.userStatus} onChange={this.handleSimple}>
        ...
        <GridContainer>
          <GridItem xs={12} sm={12} md={10}>
            ...
            <Select name="timezoneId" value={this.state.timezoneId} onChange={this.handleSimple}>
